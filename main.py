...
async def main():
    ...
    # Sound Effects
    bonk = pygame.mixer.Sound(os.path.join(current_dir, "sounds", "bonk", "bonk.ogg"))
    bonk.set_volume(1)
    huh = pygame.mixer.Sound((os.path.join(current_dir, "sounds", "huh", "huh.ogg")))
    huh.set_volume(0.1)
    ...
    while running:
        ...
        if (
            redball_rect.left < baller2_rect.right
            and redball_rect.right > baller2_rect.left
            and redball_rect.top < baller2_rect.bottom
            and redball_rect.bottom > baller2_rect.top
        ):
            bonk.play()
            redball_rect.x = 10000
            if redball_thrown == 1:
        ...
        if (
            blueball_rect.left < baller1_rect.right
            and blueball_rect.right > baller1_rect.left
            and blueball_rect.top < baller1_rect.bottom
            and blueball_rect.bottom > baller1_rect.top
        ):
            bonk.play()
            blueball_rect.x = 10000
            if blueball_thrown == 1:
